...
============================================\n\
1��jsZip������4-5����ڲ���:\n\
2���﷨��\n   cscript jsZip.js Ŀ��.htm ����.htm Դ1.js+Դ2.js+..+Դn.js ѹ�������� [ѹ������Ƿ�ֱ���˳�]\n\
3��������\n   cscript jsZip.js index.htm wnl.htm a1.js+a2.js+a3.js 1000000 y\n\
4��ע�⣺�����ļ�·�����������"�ű�.js"���Եġ�\n\
5��jsZip�������������е���ͨ����\n\
...
for(i=0; i<fs.length; i++){
 if(fs[i]=='')          { WScript.Echo('Դjs�ļ�������Ч');   getLine(); WScript.Quit(); }
 if(!fexists(ph+fs[i])) { WScript.Echo(fs[i]+' �ļ�������!'); getLine(); WScript.Quit(); }
}
...
//��js����htm��
fs=args.item(1);
if( !fexists(ph+fs) ){ WScript.Echo(fs+' ����htm������'); getLine(); WScript.Quit(); }
s2 = rfile(ph+fs);
p1=s2.indexOf('<!--js1S-->');
...
if( fexists(ph+fs) ){
  ...
  if (args.item(4) === 'y' ||args.item(4) === 'yes') {
    WScript.Echo(fs+' �Ѹ���Ŀ���ļ���');
  } else {
